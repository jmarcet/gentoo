...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/transmission/transmission-2.77.ebuild,v 1.7 2013/03/02 23:10:22 hwoarang Exp $

EAPI=5
inherit autotools eutils fdo-mime gnome2-utils qt4-r2 user subversion
...
src_install() {
	...
	keepdir /etc/${PN} /var/lib/${PN}/{config,downloads} /var/log/${PN}
	insinto /etc/${PN}
	doins "${FILESDIR}"/urls.txt
	fowners -R ${PN}:${PN} /etc/${PN} /var/lib/${PN}/{config,downloads} /var/log/${PN}
