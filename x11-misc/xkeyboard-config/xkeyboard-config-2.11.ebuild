...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/xkeyboard-config/xkeyboard-config-2.11.ebuild,v 1.1 2014/02/04 19:58:33 chithanh Exp $
...
src_prepare() {
	...
	use macbookpro_keycodes && epatch "${FILESDIR}"/macbookpro-sane_keycodes.patch
}
