...
EAPI=2
EGIT_REPO_URI="https://github.com/soreau/SDL.git"
EGIT_MASTER="wayland"
inherit flag-o-matic git-2 multilib toolchain-funcs eutils libtool
...
IUSE="oss alsa nas X dga xv xinerama fbcon directfb ggi svga tslib aalib opengl libcaca +audio +video +joystick custom-cflags pulseaudio ps3 static-libs wayland"
