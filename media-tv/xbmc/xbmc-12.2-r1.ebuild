...
EGIT_MASTER="Frodo"
inherit git-2
SRC_URI="!java? ( mirror://gentoo/${PN}-9999-20121224-generated-addons.tar.xz )"
KEYWORDS="~amd64 ~x86"
...
LICENSE="GPL-2"
SLOT="0"
IUSE="airplay airtunes alsa altivec avahi bluetooth bluray caps cec css debug gles goom java joystick midi mysql mythtv neon nfs +opengl profile +projectm pulseaudio rsxs rtmp +samba +sdl sse sse2 sftp udev upnp +usb vaapi vdpau webserver +X +xrandr"
REQUIRED_USE="
	mythtv? ( mysql )
	rsxs? ( X )
	X? ( sdl )
...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	airtunes? ( media-libs/libshairport )
	dev-libs/boost
	dev-libs/fribidi
