...
# tcp_proxy
TCP_PROXY_MODULE_URI="https://github.com/yaoweibin/nginx_tcp_proxy_module.git"
TCP_PROXY_MODULE_WD="${WORKDIR}/tcp_proxy_module"
...
src_prepare() {
	...
	if use nginx_modules_tcp_proxy; then
		git clone ${TCP_PROXY_MODULE_URI} ${TCP_PROXY_MODULE_WD}
		epatch "${TCP_PROXY_MODULE_WD}"/tcp.patch
	fi
