...
SLOT="0"
LICENSE="GPL-3"
IUSE="livecd livecd-stage1 +analyzer bindist +bluetooth cdr +cracking +database enlightenment +exploit +footprint +forensics +forging +fuzzers -gtk -kde +misc +mitm +mobile +proxies +qemu -gnome pentoo +radio +rce +scanner +voip +wireless +xfce X"
