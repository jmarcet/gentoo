...
src_prepare() {
	...
	epatch "${FILESDIR}"/iaxclient-fix-avcodec-libs.patch || die "patch failed"
	epatch "${FILESDIR}"/iaxclient-fix-avcodec.patch || die "patch failed"
	epatch "${FILESDIR}"/iaxclient-wxstring_fix.patch || die "patch failed"
