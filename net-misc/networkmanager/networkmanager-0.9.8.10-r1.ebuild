...
# $Header: /var/cvsroot/gentoo-x86/net-misc/networkmanager/networkmanager-0.9.8.10-r1.ebuild,v 1.5 2014/07/28 13:49:03 ago Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-dont_force_ipv4_only.patch"
