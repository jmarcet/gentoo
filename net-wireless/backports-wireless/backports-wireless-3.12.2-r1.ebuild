...
MY_P=backports-${PVR/-r/-}

MY_PV=v$(get_version_component_range 1-3)
DESCRIPTION="Stable kernel pre-release wifi subsystem backport"
HOMEPAGE="https://backports.wiki.kernel.org/index.php/Main_Page"
SRC_URI="mirror://kernel/linux/kernel/projects/backports/stable/${MY_PV}/${MY_P}.tar.bz2"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~arm ~x86"
IUSE="+alx +ath9k_htc atheros_obey_crda bluetooth b43 b44 debugfs debug-driver full-debug injection intel livecd loadmodules noleds pax_kernel"
