...
SR=SR${PV#*.*.}
SRC_BASE="http://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/kepler/${SR}/eclipse-standard-kepler-${SR}-linux-gtk"

DESCRIPTION="Eclipse SDK"
HOMEPAGE="http://www.eclipse.org"
SRC_URI="
	amd64? ( ${SRC_BASE}-x86_64.tar.gz&r=1 -> eclipse-standard-kepler-${SR}-linux-gtk-x86_64-${PV}.tar.gz )
	x86? ( ${SRC_BASE}.tar.gz&r=1 -> eclipse-standard-kepler-${SR}-linux-gtk-${PV}.tar.gz )"
